-- PASSO 2: Rode este script SOMENTE APÓS ter rodado o Passo 1 com sucesso.

-- 1. ADD COLUMN FOR SAFETY METRICS
ALTER TABLE daily_report_sectors ADD COLUMN IF NOT EXISTS safety_metrics JSONB DEFAULT '{}'::jsonb;

-- 2. INITIALIZE SAFETY SECTOR FOR ALL EXISTING DAILY REPORTS
...
-- 3. CREATE FUNCTION TO CALCULATE CONSOLIDATED STATUS
...
-- 4. CREATE TRIGGER FUNCTION TO UPDATE THE PARENT REPORT
...
-- 6. RECALCULATE STATUS FOR ALL EXISTING REPORTS
UPDATE daily_reports
